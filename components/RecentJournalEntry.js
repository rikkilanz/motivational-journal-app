    ...
    if(loading){
        ...
        return(
            <View className="bg-black rounded-lg my-8">
                ...
                /> */}
                <Image 
                    source={{uri: 'https://images.unsplash.com/photo-1426604966848-d7adac402bff?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80'}}
                    className="block absolute max-h-full max-w-full min-h-full min-w-full h-full w-full opacity-25 aspect-square"
                />
